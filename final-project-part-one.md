...
# Final Project Part I: Transcontinental Train Travel — Flight Speed vs. Rail Serenity
...
Across the United States, long-distance travel is overwhelmingly dominated by commercial air travel due to speed and efficiency [6]. However, an increasing number of travelers are intrigued by the romance and unique perspective of cross-country rail journeys on Amtrak’s long-distance network [6]. First-time travelers face a foundational dilemma: **Is a 48–52 hour transcontinental train journey worth the substantial investment in travel time and cost compared to flying, and what visual landscapes do you actually gain along the way?** [6]

This project evaluates the first-time traveler's journey across America by analyzing **travel duration, cost per mile, delay patterns, and geographic landscape density** [6]. By comparing two iconic transcontinental routes—the **California Zephyr** (Chicago to Emeryville/San Francisco via the Rockies and Sierra Nevada) and the **Southwest Chief** (Chicago to Los Angeles via the Red-Rock Deserts and Santa Fe Trail)—this interactive narrative provides first-time travelers with a data-grounded decision framework to determine whether to take the train or stick to flying [6].
...
### **User Story**
> **As a reader**, I want to virtually ride along on an Amtrak transcontinental journey so that I can see how America's landscapes, travel costs, and time investments change from coast to coast through a data-driven narrative supported by maps, timelines, and visualizations [6].

---

## 3. Project Outline & Story Arc

Following Scott Berinato’s **Good Charts** storytelling framework (Setup \\(\rightarrow\\) Conflict \\(\rightarrow\\) Resolution) [8, 9]:

+-----------------------------------------------------------------------------------+ | 1. SETUP: The First-Timer's Dilemma                                              | |    - Flying gets you there fast; rail travel shows you America.                    | |    - Hero Visual: AMTRAK visual title banner with region-filled photography.      | +-----------------------------------------------------------------------------------+ | v +-----------------------------------------------------------------------------------+ | 2. CONFLIC/TENSION: Time, Cost, and Delay Reality Checks                          | |    - The 4-hour vs. 50-hour trade-off.                                           | |    - Price per mile: Air vs. Coach vs. Roomette Sleeper.                        | |    - On-Time Performance & delay friction points across long-distance lines.      | +-----------------------------------------------------------------------------------+ | v +-----------------------------------------------------------------------------------+ | 3. EXPLORATION: Geographic Scenery Density & Terrain Breakdown                    | |    - Mapping 2,400 miles segment by segment.                                      | |    - California Zephyr (Mountains & Canyons) vs. Southwest Chief (Deserts & Red-Rock)| |    - Daylight Scenery Window: How much peak landscape occurs while you're awake?  | +-----------------------------------------------------------------------------------+ | v +-----------------------------------------------------------------------------------+ | 4. RESOLUTION: The First-Timer's Decision Matrix                                  | |    - Interactive 2x2 Matrix: Time Flexibility vs. Scenic Preference.             | |    - Clear recommendations tailored to budget, timeline, and travel goals.        | +-----------------------------------------------------------------------------------+

---

## 4. Initial Sketches & Wireframes

Below are initial sketches laying out key narrative sections and visual chart prototypes [3, 9]:

### **Sketch 1: Hero Header Title Art (AMTRAK Letter Photo Banner)**
*(Concept adapted from Phase 1 proposal [7])*

+-----------------------------------------------------------------------------------+ |                                                                                   | |    █████  ███    ███ ████████ ██████   █████  ██   ██                             | |   ██   ██ ████  ████    ██    ██   ██ ██   ██ ██  ██                              | |   ███████ ██ ████ ██    ██    ██████  ███████ █████                               | |   ██   ██ ██  ██  ██    ██    ██   ██ ██   ██ ██  ██                              | |   ██   ██ ██      ██    ██    ██   ██ ██   ██ ██   ██                             | |                                                                                   | |   [ A ] Appalachian/East  | [ M ] Midwest Plains     | [ T ] Rocky Mountains     | |   [ R ] Red-Rock Deserts  | [ A ] Sierra/California | [ K ] Key Destination     | |                                                                                   | |   SUBTITLE: Transcontinental Train Travel — Flight Speed vs. Rail Serenity        | +-----------------------------------------------------------------------------------+

---

### **Sketch 2: Travel Mode Trade-Off (Slope / Dot Plot)**
*(Good Charts Ch. 3 & 4: Comparison & Persuasion [10-12])*
...
### **Sketch 3: Segment Scenery & Terrain Distribution (Stacked Area / Unit Chart)**
*(Good Charts Ch. 2 & Appendix B: Proportions over journey segments [13-15])*
...
### **Sketch 4: First-Timer's Decision Matrix (2x2 Matrix)**
*(Good Charts Ch. 5: Capturing Concepts with a 2x2 Matrix [16, 17])*
...
## 5. Data Plan & Documentation

### **Data Sources Identified**
1. **Amtrak Route Timetables & Schedules:** Station arrival/departure times, route mileage, and scheduled segment durations for the *California Zephyr* and *Southwest Chief* (Sourced from Amtrak Route Guides) [1, 18, 19].
2. **Transportation Cost Comparison Dataset:** Sample economy airfares (Google Flights 12-month median), Amtrak Coach & Roomette fares, and driving expenses (AAA fuel & toll estimates).
3. **Bureau of Transportation Statistics (BTS) Long-Distance Performance:** Historical on-time performance and delay causes for Amtrak long-distance routes.
...
📄 **Data File:** [`data/amtrak_route_comparison.csv`](../data/amtrak_route_comparison.csv) [4]
